...
// nor polyfill, then a plain number is used for performance.
  ...
  var REACT_STRICT_MODE_TYPE = hasSymbol ? Symbol.for('react.strict_mode')
      : 0xeacc;
  var REACT_PROFILER_TYPE = hasSymbol ? Symbol.for('react.profiler') : 0xead2;
  var REACT_PROVIDER_TYPE = hasSymbol ? Symbol.for('react.provider') : 0xeacd;
  var REACT_CONTEXT_TYPE = hasSymbol ? Symbol.for('react.context') : 0xeace;

  var REACT_CONCURRENT_MODE_TYPE = hasSymbol ? Symbol.for(
      'react.concurrent_mode') : 0xeacf;
...
// preserve the format and params in the www builds.
    ...
    lowPriorityWarning = function (condition, format) {
      ...
      if (!condition) {
        for (var _len2 = arguments.length,
            args = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2;
            _key2++) {
...

  {
    warningWithoutStack = function (condition, format) {
      for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0),
  ...
  function warnNoop(publicInstance, callerName) {
    {
      ...
      var componentName = _constructor && (_constructor.displayName
          || _constructor.name) || 'ReactClass';
...
// This is set when a callback is being executed, to prevent re-entrancy.
  ...
  var hasNativePerformanceNow = typeof performance === 'object'
  ...
  function flushImmediateWork() {
    if (
        ...
        currentEventStartTime === -1 && firstCallbackNode !== null
      ...
      try {
        ...
        firstCallbackNode !== null && firstCallbackNode.priorityLevel
        === ImmediatePriority);
      } finally {
  ...
  function unstable_scheduleCallback(callback, deprecated_options) {
    var startTime = currentEventStartTime !== -1 ? currentEventStartTime
        : getCurrentTime();
  ...
  function unstable_shouldYield() {
    return !currentDidTimeout && (firstCallbackNode !== null
...
// on the client. https://github.com/facebook/react/pull/13088
  var localSetTimeout = typeof setTimeout === 'function' ? setTimeout
      : undefined;
  var localClearTimeout = typeof clearTimeout === 'function' ? clearTimeout
      : undefined;

// We don't expect either of these to necessarily be defined, but we will error
// later if they are missing on the client.
  var localRequestAnimationFrame = typeof requestAnimationFrame === 'function'
...
// implementation using setTimeout.
    ...
    var animationTick = function (rafTime) {
      ...
      if (nextFrameTime < activeFrameTime && previousFrameTime
          < activeFrameTime) {
        if (nextFrameTime < 8) {
...
// Listener(s) to notify when interactions begin and end.
  ...
  function cloneAndReplaceKey(oldElement, newKey) {
    var newElement = ReactElement(oldElement.type, newKey, oldElement.ref,
        oldElement._self, oldElement._source, oldElement._owner,
        oldElement.props);
  ...
  function getPooledTraverseContext(mapResult, keyPrefix, mapFunction,
      mapContext) {
  ...
  function forEachChildren(children, forEachFunc, forEachContext) {
    ...
    var traverseContext = getPooledTraverseContext(null, null, forEachFunc,
        forEachContext);
  ...
  function mapIntoWithKeyPrefixInternal(children, array, prefix, func,
      context) {
    var escapedPrefix = '';
    if (prefix != null) {
      escapedPrefix = escapeUserProvidedKey(prefix) + '/';
    }
    var traverseContext = getPooledTraverseContext(array, escapedPrefix, func,
        context);
  ...
  function createContext(defaultValue, calculateChangedBits) {
    if (calculateChangedBits === undefined) {
      ...
      {
        !(calculateChangedBits === null || typeof calculateChangedBits
            === 'function') ? warningWithoutStack$1(false,
  ...
  function forwardRef(render) {
    {
      if (render != null && render.$$typeof === REACT_MEMO_TYPE) {
        ...
        !(
            ...
            render.length === 0 || render.length === 2) ? warningWithoutStack$1(
            false,
  ...
  function isValidElementType(type) {
    return typeof type === 'string' || typeof type === 'function' ||
        ...
        || type === REACT_SUSPENSE_TYPE || typeof type === 'object' && type
        !== null && (type.$$typeof === REACT_LAZY_TYPE || type.$$typeof
            === REACT_MEMO_TYPE || type.$$typeof === REACT_PROVIDER_TYPE
            || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof
  ...
  function useContext(Context, unstable_observedBits) {
    var dispatcher = resolveDispatcher();
    {
      !(unstable_observedBits === undefined) ? warning$1(false,
          ...
          typeof unstable_observedBits === 'number' && Array.isArray(
